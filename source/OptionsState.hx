...
class OptionsState extends FlxState
{
	...
	/**
		The user wants to clear the saved data. We just call erase on our save object and then reset
		the volume to .5
	**/
	...
	/**
		The user clicked the back button. Close our save object and go back to the main menu.
	**/
	function clickBack()
	{
		FlxG.save.flush();
	...
	**/
	...
	/**
		Whenever we want to show the value of volume, we call this to change the bar and the amount
		text.
	**/
